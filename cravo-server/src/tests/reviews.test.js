...
beforeEach(async () => {
  ...
  const authorSignup = await request(app)
  ...
  console.log("AUTHOR SIGNUP:", authorSignup.status, authorSignup.body);

  expect(authorSignup.status).toBe(201);
  ...
  console.log("OTHER SIGNUP:", otherSignup.status, otherSignup.body);
